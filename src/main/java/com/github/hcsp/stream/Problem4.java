...
public class Problem4 {
    ...
    public static Map<String, List<Employee>> collect(List<Employee> employees) {
        return employees.stream().collect(Collectors.groupingBy(Employee::getDepartment, Collectors.collectingAndThen(Collectors.toCollection(ArrayList::new), employees1 -> {
            employees1.sort(Comparator.comparing(Employee::getAge));
            return employees1;
        })));
    }
