...
public class Problem1 {
    static class User {
        ...
        public static boolean nameLengthIs2(User user) {
    ...
    public static int countUsers(List<User> users) {
        return (int) users.stream().filter(Problem1::userAgeGreaterOrEqualTo60).filter(User::nameLengthIs2).count();

    }

    public static boolean userAgeGreaterOrEqualTo60(User user) {
    ...
    public static LinkedList<String> collectNames(List<User> users) {
        return users.stream().filter(Problem1::userAgeGreaterOrEqualTo60)
